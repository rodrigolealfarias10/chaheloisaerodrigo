  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-4 animate-fade-in max-w-4xl mx-auto flex flex-col justify-end" style={{ minHeight: '85vh', paddingBottom: '8vh' }}>
        ...
        <h1 className="font-cormorant text-5xl md:text-7xl font-semibold mb-8 text-white drop-shadow-2xl tracking-wide" style={{ textShadow: '0 6px 24px rgba(0,0,0,0.8)' }}>
          Bem-vindos ao Nosso Chá de Panela
        </h1>
        
        <div className="flex items-center justify-center gap-4 mb-8">
          <span className="font-cormorant text-4xl md:text-6xl font-light text-white drop-shadow-2xl" style={{ textShadow: '0 6px 24px rgba(0,0,0,0.8)' }}>Heloisa</span>
